...
public record OportunidadeUpdateRequest(
        ...
        @Schema(description = "Id da etapa em que a oportunidade deve ficar. Se diferente da etapa atual, os valores totais das etapas envolvidas são recalculados.") @NotNull(message = "Informe a etapa") Long etapaId,
