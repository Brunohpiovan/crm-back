...
public record OportunidadeClienteRequest(
        @Schema(description = "Id do participante, se já conhecido; não é usado para localizar o cliente (a busca é feita por celular), mas é retornado/aceito por conveniência")
        Long id,
