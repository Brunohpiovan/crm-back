...
public class MensagemController {
    ...
    public List<MensagemResponseDTO> getMessages(@Parameter(description = "Id do protocolo", required = true) @PathVariable Long protocoloId) {
    ...
    public List<MensagemResponseDTO> getMessagesPublic(@Parameter(description = "Id do Participante remetente", required = true) @PathVariable Long userId) {
    ...
    @ApiResponse(responseCode = "200", description = "Lista de ids de participantes", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Long.class))))
    ...
    public void deletePublicMessage(@Parameter(description = "Id do Participante remetente", required = true) @PathVariable Long userId){
