...
/**
 * Configuração central da documentação OpenAPI/Swagger da API do CRM Vincit.
 *
...
@OpenAPIDefinition(
        info = @Info(
                title = "CRM Vincit API",
                version = "v1",
                description = """
                        API REST do CRM Vincit (Faculdade Vincit).
                        ...
                        """,
                contact = @Contact(
                        name = "Equipe de Desenvolvimento - CRM Vincit",
                        email = "sistema1@faculdadevincit.edu.br"
                )
        ),
        servers = {
